   ...
   <input type="checkbox" id="menu-toggle">
    <div class="sidebar">
        ...
        <div class="side-content">
            <div class="profile">
                <div class="profile-img bg-img" style="background-image: url(../../backend/img/user_icon.png)"></div>
        ...
        <header>
            <div class="header-content">
                ...
                <div class="header-menu">
                    ...
                    <div class="user">
                        <div class="bg-img" style="background-image: url(../../backend/img/user_icon.png)"></div>
